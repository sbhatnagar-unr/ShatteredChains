...
public:
    ...
    virtual void hit_bone(const AActor *hit_by, const FName bone_name, float weapon_damage) PURE_VIRTUAL(IHasBoneCollider::hit_bone, return;);

    static void add_stats_modifiers(UPhysicsAsset* physics_asset, TMap<FName, TObjectPtr<UStatsModifier>> *stats_modifiers);
};
